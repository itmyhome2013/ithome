...
public class Urls {
	...
	private boolean checkpopedom(Map<String, Object> actionMap,
			Map<String, Map<String, String>> useraction, String url) {
		// 查看是否是受控权限
		if (actionMap == null) {
			return false;
		}
	 ...
	 * @return
	 */
	public static boolean isNoLoginUrl(String _Url) {
		if (_Url.equals("/"))
			return true;
		return getActionUrl(_Url).indexOf("nl") == 0;
	}

	/**
	 * 获得URLIndex Admin/Xxxx.do transact Url to Url(Xxxx)
	 * 
	 * @param Url
	 * @return
	 */
