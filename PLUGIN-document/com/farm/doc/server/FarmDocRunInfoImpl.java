...
public class FarmDocRunInfoImpl implements FarmDocRunInfoInter {
	...
	@Override
	public void visitDoc(String docId, AloneUser user,String ip) {
		WebVisitBuff vbuff = WebVisitBuff.getInstance("KNOW", 1000);
		if (vbuff.canVisite(docId +ip+ user.getId())) {
	...
	@Override
	public void criticalDoc(String docId, AloneUser user, String IP) {
	 ...
	 * @return 文档评价值(好评减去差评)
	 */
	private void evaluateDoc(String docId, AloneUser user, String IP,
			String type) {
		FarmDoc doc = farmDocDao.getEntity(docId);
	...
	@Override
	public void praiseDoc(String docId, AloneUser user, String IP) {
