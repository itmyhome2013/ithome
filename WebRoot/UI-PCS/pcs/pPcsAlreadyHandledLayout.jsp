...
<html>
	...
	<body class="easyui-layout">
		<div data-options="region:'north',border:false">
			<form id="dom_searchAlreadyHandledfrom">
		...
		<div data-options="region:'center',border:false">
			<table class="easyui-datagrid" id="dom_datagridAlreadyHandled">
				<thead>
					<tr>
	...
	<script type="text/javascript">
		var findAlreadyHandledListAction = "admin/AlreadyHandledAction_findAlreadyHandledList.do";//查询URL
		var datagridAlreadyHandled;//数据表格对象
		var searchAlreadyHandledfrom;//条件查询组件对象
		var TOOL_BARAlreadyHandled = [{
			id : 'AlreadyHandledviewId',
			text : '查看',
			iconCls : 'icon-eye',
			handler : viewfun
		}];
		$(function() {
		 	//初始化数据表格
			datagridAlreadyHandled = $('#dom_datagridAlreadyHandled').datagrid( {
				url : findAlreadyHandledListAction,
				fit : true,
				fitColumns : true,
				'toolbar' : TOOL_BARAlreadyHandled,
				pagination : true,
				closable : true,
				checkOnSelect : true,
				singleSelect:false,
			...
			//初始化条件查询
			searchAlreadyHandledfrom = $('#dom_searchAlreadyHandledfrom').searchForm( {
				gridObj : datagridAlreadyHandled
			}); 
		});
		
     function viewfun(){
    	 var selectedArray = $(datagridAlreadyHandled).datagrid('getSelections');
