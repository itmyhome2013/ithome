...
<table class="easyui-datagrid" id="dom_datagridfrmfield">
	<thead>
		<tr>
			...
			<th field="TASKKEY" data-options="sortable:true" width="60">任务节点KEY</th>
			<th field="TASKNAME" data-options="sortable:true" width="50">任务节点名称</th>
			<th field="FORMNAME" data-options="sortable:true" width="60">表单名称</th>
			<th field="FROMTYPE" data-options="sortable:true" width="50">表单类型</th>
			<th field="FORMURL" data-options="sortable:true" width="80">表单URL</th>
		</tr>
	</thead>
</table>
<script type="text/javascript">
	var url_delActionfrmfield = "admin/FrmConfigFormdeleteCommit.do";//删除URL
	var url_formActionfrmfield = "admin/FrmConfigFormshow.do";//增加、修改、查看URL
	var url_searchActionfrmfield = "admin/FrmConfigFormqueryAll.do";//查询URL
	...
	$(function() {
		...
		gridfrmfield = $('#dom_datagridfrmfield').datagrid( {
			url : url_searchActionfrmfield + '?taskKey='+"${taskKey}",
			fit : true,
			fitColumns : true,
	...
	function addDatafrmfield() {
		var url = url_formActionfrmfield + '?pageset.pageType='+PAGETYPE.ADD+'&taskKey=' + $("#taskKey").val();
		$.farm.openWindow( {
			id : 'winfrmfield',
			width : 750,
			height : 310,
