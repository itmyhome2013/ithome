...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'">
		<form id="dom_formfrmtable">
			...
			<input type="hidden" name="entity.taskname" id="entity_taskname" value="${entity.taskname}">  <!-- 任务节点名称 -->
			<table class="editTable">
				...
				<tr>
					...
					<td>
						<input type="text" readonly="readonly" style="width: 180px;" class="easyui-validatebox" data-options="required:true,validType:['unnormal','maxLength[30]']" 
					    	id="entity_taskkey" name="entity.taskkey" value="${entity.taskkey }">
					</td>
					<td class="title">
						表单名称:
					</td>
				...
				<tr>
					...
					<td style="display:none;" name="word">
						<select id="entity_word" name="entity.word"  val="${entity.word}" class="easyui-validatebox" data-options="required:false"  style="width: 180px">
							<option value="">请选择</option>
							<PF:OptionWordList isTextValue="1" />
						</select>
					</td>
				</tr>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#dom_edit_entityfrmtable').bind('click', function() {
			...
			var wordurl = $("#entity_word option:selected").attr("title");
			$("#entity_wordurl").val(wordurl);
			
			var formtableid = $("#entity_formtablename option:selected").attr("title");
			$("#entity_formtableid").val(formtableid);
	...
	$(function(){
		...
		var fromtype = "${entity.fromtype}";

		$("#entity_word").val("${entity.formtablename}");  //选择文件 回显
