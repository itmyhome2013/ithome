...
<script type="text/javascript"
	src="<PF:basePath/>PLUGIN/pop/commons/jquery.easyui.min.js"></script>
<script type="text/javascript"
	src="WEB-FACE/model/easy_ui_1_3_6/easyui-lang-zh_CN.js"></script>
<link rel="stylesheet" type="text/css"
	href="PLUGIN/pop/commons/base.css">	
<script src="<PF:basePath/>PLUGIN/pop/commons/jquery.platex.js"
	language="javascript" type="text/javascript"></script>
<script src="<PF:basePath/>PLUGIN/pop/commons/jquery.platex.side.js"
	language="javascript" type="text/javascript"></script>
<script src="<PF:basePath/>PLUGIN/pop/commons/jquery.validate.exp.js"
	language="javascript" type="text/javascript"></script>
<script type="text/javascript">
	$(function() {
		$.ajaxSetup( {
