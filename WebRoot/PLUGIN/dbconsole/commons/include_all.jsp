...
<link rel="stylesheet" type="text/css"
	href="PLUGIN/dbconsole/commons/base.css">	
...
<script src="<PF:basePath/>PLUGIN/dbconsole/commons/jquery.platex.js"
	language="javascript" type="text/javascript"></script>
<script src="<PF:basePath/>PLUGIN/dbconsole/commons/jquery.platex.side.js"
	language="javascript" type="text/javascript"></script>
<script src="<PF:basePath/>PLUGIN/dbconsole/commons/jquery.validate.exp.js"
	language="javascript" type="text/javascript"></script>
<script type="text/javascript">
	$(function() {
		$.ajaxSetup( {
