...
public class FarmConstant {
	 ...
	 * SESSION系统所有受检权限
	 */
	public static final String CONTEXT_ALLACTION = "ALLACTION";
	
	/**
	 * 系统参数--用户默认密码
	 */
	public static final String PARA_DEFULT_PASSWORD="DEFAULT_PASSWORD";
	/**
	 * cookie用户名--键
	 */
	public static final String COOKIE_USERNAME="KNOWUSERNAME";
	/**
	 * cookie用户密码--键
	 */
	public static final String COOKIE_PASSWORD="KNOWPASSWORD";
